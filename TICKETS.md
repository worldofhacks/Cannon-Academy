...
| T-020 | Duel reducer — the pure turn-based state machine                               | tests-written | T-004, T-006, T-007, T-008, T-013        | `ticket/T-020-duel-reducer`             | capable  | **frozen** AC-24/tsc dispute fixed; implementer retry                               |
