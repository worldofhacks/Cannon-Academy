> **Historical engine ticket ledger (A-044).** Wave tables below are snapshots, not live status.
> Canonical cross-track index: [`tickets/INDEX.md`](tickets/INDEX.md) (generated by
> `scripts/docs/build-ticket-index.mjs`). Per-ticket frontmatter remains authoritative for each file.
