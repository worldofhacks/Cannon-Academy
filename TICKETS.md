...
| T-020 | Duel reducer — the pure turn-based state machine                               | in-progress | T-004, T-006, T-007, T-008, T-013        | `ticket/T-020-duel-reducer`             | capable  | impl `6ef7aaf`; frozen `80c4cdb1…`; code/security review go                         |
