...
| T-031 | Resolve the Perfect Shot "bonus ball" contradiction                              | done    | T-004        | frozen `d9a938bbe96cf2af…`; Perfect Shot = +1 damage; QUALITY_WEIGHT > 0.6                                                               |
| T-028 | CHOICE_COUNT must have one home, not two                                         | done    | T-003, T-004 | frozen `76dafbc2a5ea4aa5…`; single home in tuning.ts                                                                                     |
...
| T-027 | validateCatalogs must detect set-level catalog corruption                        | done    | T-006        | frozen `2e94841e5706c896…`; set-level validateCatalogs                                                                                   |
| T-025 | Replace the expression evaluator's recursive walks with explicit-stack iteration | done    | T-002        | frozen `7ccb82a558204203…`; iterative walks; stack-proof by construction                                                                 |
