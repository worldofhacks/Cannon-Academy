...
| T-018 | Opponent interface and scripted onboarding rival                               | tests-written | T-003, T-004, T-006, T-013               | `ticket/T-018-onboarding-rival`         | standard | **frozen** `344d3091662158cd…` DoD-3 header dispute fixed; implementer retry        |
