...
| T-017 | Gunnery-range drill session — full-rate mastery practice loop                  | tests-written | T-001, T-003, T-004, T-007, T-010        | `ticket/T-017-range-drill`              | standard | **frozen** `34755b6a6e6d2c2e…` ACCEPT_WITH_NITS; implementer go                     |
