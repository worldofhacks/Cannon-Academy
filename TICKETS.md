...
| T-017 | Gunnery-range drill session — full-rate mastery practice loop                  | in-progress | T-001, T-003, T-004, T-007, T-010        | `ticket/T-017-range-drill`              | standard | impl `2572fbd`; frozen `7db026f6…`; code/security review go                         |
