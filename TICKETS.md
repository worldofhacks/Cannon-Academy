...
| id    | title                                                                          | status      | deps                                     | branch                                  | model    | issue                                      |
| ----- | ------------------------------------------------------------------------------ | ----------- | ---------------------------------------- | --------------------------------------- | -------- | ------------------------------------------ |
| T-014 | Question templates — K–2 addition and subtraction (symbolic only)              | tests-written | T-001, T-003, T-004, T-005, T-007        | `ticket/T-014-templates-k2-addsub`      | standard | **frozen** `66e68a23fc4570a7…` ACCEPT_WITH_NITS; implementer go |
| T-015 | Question templates — grade 2–3 place value, two-step add/sub, mult facts       | in-progress | T-001, T-003, T-004, T-005, T-006, T-007 | `ticket/T-015-templates-g23`            | standard | Wave 5 — Test Agents dispatched            |
| T-016 | Question templates — grade 3–5 division, fractions, multi-digit / order of ops | in-progress | T-001, T-003, T-004, T-005, T-007        | `ticket/T-016-templates-g35`            | capable  | Wave 5 — Test Agents dispatched            |
...
| T-032 | Placement grants starter cannons only (D-6) | tests-written | T-010, T-011 | `ticket/T-032-placement-unlock-overlap` | standard | **frozen** + ACCEPT_WITH_NITS; implementer go |
...
| T-032 | Placement grants starter cannons only — range guns stay mastery-earned           | in-progress | T-010, T-011 | **D-6 applied** 2026-07-28 — starters only; amend T-011 ACs + placement suite                                                            |
