...
| T-034 | Narrow template param keys to the expression-identifier grammar                | tests-written | T-003                                    | `ticket/T-034-param-key-grammar`        | standard | **frozen** `fcf0e43f560bc63a…` style+feat green; implementer finish / reviews go    |
