...
| id    | title                                                                          | status      | deps                                     | branch                                  | model    | issue                                      |
| ----- | ------------------------------------------------------------------------------ | ----------- | ---------------------------------------- | --------------------------------------- | -------- | ------------------------------------------ |
| T-014 | Question templates — K–2 addition and subtraction (symbolic only) | tests-written | T-001, T-003, T-004, T-005, T-007 | `ticket/T-014-templates-k2-addsub` | standard | **frozen** `63628812983a2e2b…` dispute fixed `a0cbaeb`; implementer go |
...
| T-016 | Question templates — grade 3–5 division, fractions, multi-digit / order of ops | tests-written | T-001, T-003, T-004, T-005, T-007 | `ticket/T-016-templates-g35` | capable | **frozen** `026215158d38c033…` ACCEPT; implementer go |
