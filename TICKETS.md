...
| T-017 | Gunnery-range drill session — full-rate mastery practice loop                  | tests-written | T-001, T-003, T-004, T-007, T-010        | `ticket/T-017-range-drill`              | standard | **frozen** ACCEPT_WITH_NITS; implementer go                                         |
