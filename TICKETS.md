...
| id    | title                                                                          | status      | deps                                     | branch                                  | model    | issue                                      |
| ----- | ------------------------------------------------------------------------------ | ----------- | ---------------------------------------- | --------------------------------------- | -------- | ------------------------------------------ |
| T-014 | Question templates — K–2 addition and subtraction (symbolic only)              | tests-written | T-001, T-003, T-004, T-005, T-007        | `ticket/T-014-templates-k2-addsub`      | standard | Wave 5 — Test Agents dispatched            |
