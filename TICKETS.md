...
| T-020 | Duel reducer — the pure turn-based state machine                               | tests-written | T-004, T-006, T-007, T-008, T-013        | `ticket/T-020-duel-reducer`             | capable  | impl `6ef7aaf`; T-013 allowlist fixed; implementer finish gates                     |
