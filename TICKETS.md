...
| T-020 | Duel reducer — the pure turn-based state machine                               | in-progress | T-004, T-006, T-007, T-008, T-013        | `ticket/T-020-duel-reducer`             | capable  | RED `d43dfd7`; bySkill+rival recoil adjudicated; test-design review go              |
