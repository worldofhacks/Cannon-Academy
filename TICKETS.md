...
| T-015 | Question templates — grade 2–3 place value, two-step add/sub, mult facts | tests-written | T-001, T-003, T-004, T-005, T-006, T-007 | `ticket/T-015-templates-g23` | standard | **frozen** `f941a204069afed6…` ACCEPT_WITH_NITS; implementer go |
| T-016 | Question templates — grade 3–5 division, fractions, multi-digit / order of ops | tests-written | T-001, T-003, T-004, T-005, T-007 | `ticket/T-016-templates-g35` | capable | **frozen** `a48a7e7ffe7d41e7…` ladder fix `eea35ac`; implementer go |
